// This code defines a SystemManager class which manages an airline reservation system
// It imports necessary classes and libraries for the class
package Classes;

import GUI.*; //importing the GUI class
import java.io.*; //importing the input-output library
import java.util.Arrays; //importing the Arrays library
import java.util.Scanner; //importing the Scanner library
import java.util.logging.Level; //importing the Level class of logging library
import java.util.logging.Logger; //importing the Logger class of logging library
import javax.swing.JOptionPane; //importing the JOptionPane class of the Swing library

//This class manages the airline reservation system
public class SystemManager {
   
private String inputFile;       //stores the path of the input file which contains all details    
...
private Reservation[] reservations = new Reservation[448]; //stores details of all reservations
public static int reservationNumber = -1; //a static variable to store the reservation number

//This constructor initializes the class variables by calling several methods
public SystemManager(String inputFile){
    this.inputFile = inputFile;
    this.readAirportDetails(); //reading airport details from the input file
    this.readAirLineDetails(); //reading airline details from the input file
    this.readFlightDetails();  //reading flight details from the input file
    this.setFlightSeatDetails(); //setting the seat details for each flight
    this.loadReservations(); //loading all the reservations made by users
}

//setter method for airport array
public void setAirport(Airport[] airport) {
    this.airport = airport;
}

//setter method for airlines array
public void setAirlines(Airline[] airline) {
    this.airlines = airline;
}

//setter method for flights array
public void setFlights(Flight[] flight) {
    this.flights = flight;
}

//setter method for seats array
public void setSeat(Seat[][] seat) {
    this.seats = seat;
}

//setter method for input file path
public void setInputFile(String inputFile) {
    this.inputFile = inputFile;
}

//setter method for reservations array
public void setReservations(Reservation[] reservations) {
    this.reservations = reservations;
}

//getter method for airport array
public Airport[] getAirport() {
    return airport;
}

//getter method for airlines array
public Airline[] getAirlines() {
    return airlines;
}

//getter method for flights array
public Flight[] getFlights() {
    return flights;
}

//getter method for seats array
public Seat[][] getSeat() {
    return seats;
}

//getter method for input file path
...
// create an array to store airport details (ID, city, country)
String[] airportDetails = new String[3];
// initialize empty strings for airport details
String airportID = "";
String airportCity = "";
...
int i = 0;
    ...
    while(read.hasNextLine()&& !end){
        ...
        // if line equals "**" then read airline details
        if(line.compareTo("**") == 0){
            // split the line into separate details using commas
            airlineDetails = read.nextLine().split(",");
            // get the ID and name from the details array
            airlineID = airlineDetails[0];
            airlineName = airlineDetails[1];

            // create a new Airline object with the details and add it to the airline array
            airline[i] = new Airline(airlineID, airlineName);                    
             // write the Airline object to the airline.txt file
...
// catch exceptions if the file is
